...
def main() -> int:
    ...
    with contextlib.ExitStack() as stack:
        ...
        run_nova(["import", str(image), str(REPO / "software/languages/ehbasic/basic.bin")])
        ...
        run_nova(["rom", "upload", str(REPO / "software/languages/ehbasic/basic.bin"), "--remote", remote, "--name", "novabasic.bin"])
