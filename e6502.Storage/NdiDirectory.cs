...
public enum NdiFileType : byte { Bas = 0, Sid = 1, Bin = 2, Mid = 3, Gfx = 4, Dir = 5, Forth = 6, Logo = 7, Pascal = 8, Assembly = 9 }
...
///   $01      File type (0=BAS,1=SID,2=BIN,3=MID,4=GFX,5=DIR,6=FORTH,7=LOGO,8=PASCAL,9=ASM)
