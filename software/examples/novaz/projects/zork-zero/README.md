...
```text
software/examples/novaz/projects/zork-zero/STORY.BIN   # Zork0.z6
software/examples/novaz/projects/zork-zero/PICS.BLB    # Zork0.blb (graphics blorb)
```

Build:

```sh
make -C software/examples/novaz ndi PROJECT=zork-zero
```

The generated image is written to `software/examples/novaz/dist/zork-zero/fd0.ndi`
...
outside graphics state is replayed. Run `make -C software/examples/novaz test-z6-spec`
...
e6502.Nova/bin/Release/net10.0/osx-arm64/nova disk upload \
  software/examples/novaz/dist/zork-zero/fd0.ndi \
