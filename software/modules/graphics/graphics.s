...
; the tween domain $D0-$DA are live (batch 4b.11). The $B0-$BF turtle range is now
; UNUSED here: the turtle ($B0-$B3) was extracted into the dedicated TURTLE module
; (MODULE_ID_TURTLE = $07, modules/turtle/turtle.s); $B0-$BF stay reserved.
...
;@module GRAPHICS
;@version 1.0
;@brief Nova virtual graphics controller: drawing, text, sprites, copper, blitter, vsprites, meta-sprites, images, animation, tweening.
;
;@fn GFN_GCLS
;@ndk vgc_gcls
...
;@status LERR_OK, LERR_IMAGE_FAIL
;
; NOTE: the $B0-$B3 turtle fns were extracted into the dedicated TURTLE module
; (MODULE_ID_TURTLE = $07); see modules/turtle/turtle.s + runtime/asm/libturtle.inc.
;
;@fn GFN_ANIM_INIT
;@ndk anim_init
;@ret void
...
gfx_jtable:
      ...
      .word   gfn_unimpl-1             ; $B0 (turtle extracted -> MODULE_ID_TURTLE $07)
      .word   gfn_unimpl-1             ; $B1 (turtle extracted -> MODULE_ID_TURTLE $07)
      .word   gfn_unimpl-1             ; $B2 (turtle extracted -> MODULE_ID_TURTLE $07)
      .word   gfn_unimpl-1             ; $B3 (turtle extracted -> MODULE_ID_TURTLE $07)
