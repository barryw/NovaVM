...
dotnet run --project e6502.TUI                  # Run TUI (Terminal.Gui)
```
...
|---------|--------|---------|
| `e6502` | net6.0 | Core emulator library (CPU, bus, opcodes) |
| `e6502UnitTests` | net6.0 | MSTest tests using real 6502 test ROMs |
| `e6502.CLI` | net7.0 | Console-based BASIC interpreter |
| `e6502.TUI` | net7.0 | Terminal.Gui-based interface |
...
**Bus** (`e6502/BusDevice.cs`) — Implements `IBusDevice` interface (Read/Write). Default is a flat 64KB RAM array. CLI/TUI provide custom implementations with I/O intercepts for BASIC.
