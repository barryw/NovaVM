...
zvm_compute_checksum:
        JSR zvm_load_verify_copy
        BNE @error

        LDA zstory_filelen_lo
        STA zvm_verify_end_l
        LDA zstory_filelen_hi
        STA zvm_verify_end_m
        STZ zvm_verify_end_h
        ...
        CMP #$06
        BCC @scale_v4_v5
        JSR zvm_verify_shift_end
@scale_v4_v5:
        JSR zvm_verify_shift_end
@scale_v1_v3:
        JSR zvm_verify_shift_end
        LDA zvm_verify_end_h
        CLC
        ADC #ZVM_VERIFY_SCRATCH_ADDRH
        STA zvm_verify_end_h

        LDA #$40
        STA zstory_addr_l
        STZ zstory_addr_m
        LDA #ZVM_VERIFY_SCRATCH_ADDRH
        STA zstory_addr_h
...
zvm_load_verify_copy:
        JSR zvm_use_story_name
        STZ XRAM_ADDRL
        STZ XRAM_ADDRM
        LDA #ZVM_VERIFY_SCRATCH_ADDRH
        STA XRAM_ADDRH
