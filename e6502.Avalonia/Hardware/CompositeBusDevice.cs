...
public class CompositeBusDevice : IBusDevice, IDisposable
{
    ...
    private void ResetBoardInputIrqState()
    {
        _boardButtonState &= VgcConstants.BoardButtonMask;
        _boardSwitchState &= VgcConstants.BoardSwitchMask;
        _boardInputIrqEnable = 0;
        _boardInputIrqStatus = 0;
        _boardButtonChanges = 0;
        _boardSwitchChanges = 0;
    }
