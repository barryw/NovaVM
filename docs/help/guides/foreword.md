...
architecture of the original -- 64KB of address space, stack at
`0100`--`01FF`, clean interrupt model -- and pairs it with
hardware that no real 8-bit machine ever had: a 320x200 pixel bitmap with
16 colors, sixteen hardware sprites each 16x16 pixels and multicolor, a
six-voice synthesizer with ADSR envelopes and four waveforms, 512KB of banked
...
*Enhanced BASIC 2.22p5* -- itself a carefully crafted piece of work --
NovaBASIC keeps everything that made classic BASIC approachable: line numbers,
`PRINT`, `FOR`/`NEXT`, `GOSUB`, the immediacy of typing a line
