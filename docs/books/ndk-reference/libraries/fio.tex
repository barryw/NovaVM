...
routes through the host's program/file delete path; on hosted BASIC program
files it also removes the companion \novacode{.md} document when present. Host
directory devices allow paths and mounted-device prefixes; invalid names or
missing mounted media report through the normal error registers.
