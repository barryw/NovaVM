...
VGC MemRead/MemWrite space & \$03 (\texttt{MemSpaceGfx}) \\
...
20 POKE $A011, 3               : REM P0 = space (MemSpaceGfx)
...
VGC MemRead/MemWrite space & \$04 (\texttt{MemSpaceSprite}) \\
...
30 POKE $A011, 4               : REM P0 = space (MemSpaceSprite)
40 FOR ROW = 0 TO 15
