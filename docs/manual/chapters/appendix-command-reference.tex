...
MUSIC voice,"mml"            & Load MML sequence into \textit{voice} (1--6). \\[3pt]
...
MUSIC PRIORITY v1{[},v2{[},\ldots{}v6{]}{]} & Set voice-stealing priority for SFX. \\[3pt]
...
MNOTE(voice)    & Current MIDI note number on \textit{voice} (1--6), or 0 if silent. \\
\end{longtable}
