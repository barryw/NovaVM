...
Full register-level documentation for every VGC and VSC command --- including
parameters for drawing, sprites, and sound sequencing --- is planned for a future
edition of this guide. The current source of truth is
\texttt{e6502.Avalonia/Hardware/VgcConstants.cs}, which lists every register address
and command code with inline comments.

%% ============================================================
\section{Future Directions}
%% ============================================================

This chapter will grow as the hardware interfaces stabilize. Planned additions:

\begin{itemize}
  \item Complete VGC register reference: all drawing commands with full parameter
        tables.
  \item VSC register reference: sound and envelope control from assembly.
  \item Stable calling conventions and register preservation rules for BASIC-to-assembly
        transitions.
  \item Worked examples: a full-screen raster effect using XRAM windows and a
        VSC-driven interrupt music player.
\end{itemize}
