...
616 POKE 45520+SY*80+SX,2*16+CB:SOUND 60+FL*3,2,0
...
722 LOCATE 62,16:PRINT "FINAL SCORE"
723 LOCATE 62,17:PRINT "BLACK: ";S1
724 LOCATE 62,18:PRINT "WHITE: ";S2
725 GOSUB 920:REM Play game-over sound
730 LOCATE 62,21:PRINT "PLAY AGAIN?"
731 LOCATE 62,22:PRINT "(Y/N)"
732 GET K:IF K=0 THEN GOTO 732
733 IF K=89 OR K=121 THEN GOTO 45
734 IF K=78 OR K=110 THEN GOTO 740
735 GOTO 732
...
960 LOCATE 64,8:PRINT "BLACK: ";S1;" "
961 LOCATE 64,10:PRINT "WHITE: ";S2;" "
963 LOCATE 64,13
