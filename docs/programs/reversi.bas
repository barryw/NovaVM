...
12 DIM VM(63,2)
13 INSTRUMENT 0,$40,0,8,0,6:REM Pulse click
14 INSTRUMENT 1,$10,2,6,8,8:REM Triangle mellow
15 VOLUME 15
...
30 FOR I=0 TO 15:SPRITEDATA 0,I,0,0,0,0,0,0,0,0:SPRITEDATA 1,I,0,0,0,0,0,0,0,0:NEXT I
31 SPRITEDATA 0,0,$33,$33,$33,$33,$33,$33,$33,$33
32 SPRITEDATA 0,1,$30,$00,$00,$00,$00,$00,$00,$03
33 FOR I=2 TO 6:SPRITEDATA 0,I,$30,$00,$00,$00,$00,$00,$00,$03:NEXT I
34 SPRITEDATA 0,7,$33,$33,$33,$33,$33,$33,$33,$33
35 SPRITEDATA 1,0,$22,$22,$22,$22,$22,$22,$22,$22
36 SPRITEDATA 1,1,$20,$00,$00,$00,$00,$00,$00,$02
37 FOR I=2 TO 6:SPRITEDATA 1,I,$20,$00,$00,$00,$00,$00,$00,$02:NEXT I
38 SPRITEDATA 1,7,$22,$22,$22,$22,$22,$22,$22,$22
39 SPRITESHAPE 0,0:SPRITESET 0,6,2
40 GOSUB 800:REM Title screen
45 CLS:SPRITE 0,ON:GOSUB 400:GOTO 50
50 REM === NEW GAME ===
...
57 GOSUB 530:GOSUB 550:GOSUB 963
...
140 GOSUB 963:REM Update turn display
141 IF PT=2 THEN GOTO 300
145 GOTO 101
300 REM === AI TURN ===
301 GOSUB 963:REM Show "AI THINKING.."
...
335 GOSUB 963:REM Show "YOUR TURN"
340 GOTO 101:REM Back to main loop
400 REM === DRAW BOARD ===
401 COLOR 9,0:REM Brown grid lines
402 REM Column labels
403 COLOR 7,0
404 FOR I=0 TO 7:LOCATE BL+1+I*4,BT-1:PRINT CHR$(65+I);:NEXT I
405 COLOR 9,0
406 REM Top border
...
419 PRINT CHR$(179);
420 REM Row label
421 COLOR 7,0:LOCATE BL-2,BT+1+R*2:PRINT STR$(R+1);:COLOR 9,0
422 REM Separator (except after last row)
423 IF R=7 THEN GOTO 430
...
448 FOR I=0 TO 2:POKE 45520+SY*80+SX+I,CB:NEXT I
449 NEXT C:NEXT R:RETURN
460 REM === UPDATE CURSOR SPRITE POSITION ===
461 QX=BL*4+2+CX*16:QY=BT*8+8+CY*16
462 SPRITE 0,QX,QY
465 RETURN
...
555 POKE 45520+SY*80+SX,3:REM Cyan
556 NEXT I
560 RETURN
...
571 POKE 45520+SY*80+SX,CB:REM Green
572 NEXT I
575 RETURN
...
616 POKE 45520+SY*80+SX,2:SOUND 60+FL*3,2,0
...
705 IF S1>S2 THEN W$="YOU WIN!":WC=3:GOTO 720
706 IF S2>S1 THEN W$="AI WINS!":WC=2:GOTO 720
707 W$="IT'S A DRAW!":WC=7
720 COLOR WC,0
721 LOCATE 62,14:PRINT W$
722 COLOR 7,0
...
734 IF K=89 OR K=121 THEN GOTO 45
735 IF K=78 OR K=110 THEN GOTO 740
736 GOTO 733
740 CLS:FONT 0:LOCATE 0,0:PRINT "THANKS FOR PLAYING!":END
800 REM === TITLE SCREEN ===
801 FONT 1:CLS:SPRITE 0,OFF
802 COLOR 3,0
803 LOCATE 17,3:PRINT "OOOOOOO  OOOOOO O     O OOOOOO OOOOO   OOOO O"
804 LOCATE 17,4:PRINT "O     O  O      O     O O      O    O O     O"
805 LOCATE 17,5:PRINT "OOOOOOO  OOOOO  O     O OOOOO  OOOOO   OOOO O"
806 LOCATE 17,6:PRINT "O  O     O       O   O  O      O  O       O O"
807 LOCATE 17,7:PRINT "O   OO   OOOOOO   OOO   OOOOOO O   OO OOOO  O"
810 COLOR 12,0
811 LOCATE 18,10:PRINT "INSPIRED BY COMMODORE 64 FUN & GAMES (1984)"
812 COLOR 7,0
813 LOCATE 33,13:PRINT "YOU ARE BLACK"
814 COLOR 1,0
815 LOCATE 33,14:PRINT "AI  IS WHITE"
816 COLOR 14,0
817 LOCATE 28,17:PRINT "ARROW KEYS TO MOVE CURSOR"
818 LOCATE 28,18:PRINT "SPACE TO PLACE YOUR PIECE"
820 COLOR 3,0
821 LOCATE 29,21:PRINT "PRESS ANY KEY TO START"
822 GOSUB 930:REM Title jingle
...
955 NEXT XX:NEXT YY
956 COLOR 14,0:REM Light blue box
957 LOCATE 62,4:PRINT CHR$(218);:FOR I=0 TO 14:PRINT CHR$(196);:NEXT I:PRINT CHR$(191)
958 LOCATE 62,5:PRINT CHR$(179);:COLOR 1,0:PRINT "   REVERSI     ";:COLOR 14,0:PRINT CHR$(179)
959 LOCATE 62,6:PRINT CHR$(192);:FOR I=0 TO 14:PRINT CHR$(196);:NEXT I:PRINT CHR$(217)
960 COLOR 7,0:LOCATE 64,8:PRINT "BLACK: ";:COLOR 15,0:PRINT S1;" "
961 COLOR 7,0:LOCATE 64,10:PRINT "WHITE: ";:COLOR 15,0:PRINT S2;" "
963 LOCATE 64,13
964 IF PT=1 THEN COLOR 1,0:PRINT "YOUR TURN    ":SPRITESHAPE 0,0
965 IF PT=2 THEN COLOR 10,0:PRINT "AI THINKING..":SPRITESHAPE 0,1
966 RETURN
