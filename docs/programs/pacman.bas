...
1885 GU(I)=4:GY(I)=72
1890 GS(I)=0:GD(I)=2:GP(I)=0
1895 RETURN
1900 REM === CHOOSE RANDOM DIRECTION FOR GHOST I ===
1905 RV=GD(I) EOR 1:NC=0
1910 FOR DR=0 TO 3
1911 IF DR=RV THEN GOTO 1930
1912 REM CHECK IF DIRECTION DR IS PASSABLE
1913 NX=GT(I):NY=GU(I)
1914 IF DR=0 THEN NY=NY-1
1915 IF DR=1 THEN NY=NY+1
1916 IF DR=2 THEN NX=NX-1
1917 IF DR=3 THEN NX=NX+1
1918 IF NX<0 THEN NX=19
1919 IF NX>19 THEN NX=0
1920 IF NY<0 OR NY>11 THEN GOTO 1930
1921 TV=M(NX,NY)
1922 IF TV=1 THEN GOTO 1930
1925 VC(NC)=DR:NC=NC+1
1930 NEXT DR
1935 IF NC=0 THEN RETURN
1940 GD(I)=VC(INT(RND(1)*NC))
1945 RETURN
