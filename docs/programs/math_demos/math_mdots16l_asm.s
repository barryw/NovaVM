...
; ca65 --cpu w65c02 -I docs/programs/math_demos -I runtime/asm -o /tmp/math_mdots16l_asm.o docs/programs/math_demos/math_mdots16l_asm.s
...
demo_title:
        .byte "MDOTS16L(ax,ay,bx,by) - assembly dot low",0
