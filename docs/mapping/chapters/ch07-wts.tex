...
\begin{tipbox}
The MML \texttt{MUSIC} command supports WTS voices with the \texttt{@W}
prefix.  For example, \texttt{MUSIC 6, "@W0 L4 CDEFG"} plays a C major scale
on WTS voice~0 using instrument~0.  This is often easier than direct register
manipulation for musical sequences.
\end{tipbox}
