...
\begin{itemize}
  \item \textbf{Transparency:} Colour index~0 (black) serves as the transparent
        ...
        show through.
  \item \textbf{Default colours:} At power-on, the text foreground is~15
        (light grey), the background is~0 (black), and the border is~11
        (dark grey).
  \item \textbf{Boot screen:} The EhBASIC cold-start routine sets the
        same Nova dark theme and starts the banner on row~1 to leave breathing
        room on 80$\times$50 displays.
