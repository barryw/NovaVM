...
Text output flags used by \addr{A00E} and BASIC \texttt{PRINT}. Bit~0 enables
reverse text. Bit~1 makes reverse text use \addr{A0E7} instead of the default
foreground/background swap. Bit~2 marks newly printed cells as flashing.
