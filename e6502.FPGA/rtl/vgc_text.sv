...
module vgc_text (
    ...
    // =========================================================================
    assign char_b_addr  = real_row * COLS + {4'b0, text_col};
    assign color_b_addr = real_row * COLS + {4'b0, text_col};
