// Ozmoo-shaped XRAM load regression.
//
// Mirrors the NovaHost FIO XLOAD path used by Ozmoo:
...
module test_ozmoo_xram_roundtrip;
    ...
    initial begin
        $display("=== Ozmoo XRAM load/readback regression ===");
        ...
        // Ozmoo's first reads after XLOAD are header bytes from XRAM $000000.
