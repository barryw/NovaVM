// Unit tests for debug_spi_slave.sv.
//
// Exercises the SPI mode-0 byte transport used by NovaHost to feed the
// existing debug_bridge ready/valid protocol.

`timescale 1ns/1ps

module test_debug_spi_slave;
    ...
    initial begin
        ...
        if (fail_count == 0) begin
            $display("All %0d debug SPI tests passed", pass_count);
            $finish;
        end else begin
